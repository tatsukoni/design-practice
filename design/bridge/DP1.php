...
class DP1
{
    public function draw_a_line(int $x1, int $y1, int $x2, int $y2)
    { 
        if ($x1 === $x2) {
    ...
    {
        $resultLine;
        for ($index = 0; $index < abs($x2 - $x1); $index++) {
            $resultLine .= '_';
        }
    ...
    {
        $resultLine = '';
        for ($index = 0; $index < abs($y2 - $y1); $index++) {
            $resultLine .= '|';
            $resultLine .= "\n";
        }
    ...
    public function draw_a_circle(int $x1, int $y1, int $r)
    {
